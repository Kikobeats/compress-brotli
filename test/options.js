...
operationCycleMacro.title = (caseTitle = '', operationName) =>
  `${caseTitle} to ${operationName.toLowerCase()}`.trim()

;['Compress', 'Decompress'].forEach(operationName => {
  test(
    'by default should provide no options',
    operationCycleMacro,
    operationName,
    {}
  )
  ...
  test(
    'should bypass call level options',
    operationCycleMacro,
    operationName,
    {
      chunkSize: 1024
  ...
  test(
    'should bypass factory level options',
    operationCycleMacro,
    operationName,
    {
      chunkSize: 1024
  ...
  test(
    'should merge call-into-factory level options',
    operationCycleMacro,
    operationName,
    {
  ...
  test(
    'should deep merge call-into-factory level option.parameters',
    operationCycleMacro,
    operationName,
    {
      params: {
